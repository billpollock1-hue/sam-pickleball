...
def automate_signup_search_today(page):
    ...
    try:
        ...
        # over it.
        # Reverted 2026-09-14: the unanchored substring match above
        # (introduced 2026-09-13) was a real bug, not a fix -- a live
        # strict-mode-violation error proved it matched TWO buttons
        # simultaneously (this one, AND the unrelated "Search Play Type"
        # dropdown, whose accessible name is "Search Play Type None" and
        # therefore also contains the substring "Search"). That same error
        # message showed Playwright's own suggested unique locator for the
        # correct button is exactly this exact-match form -- meaning the
        # ORIGINAL selector (before any of our changes) was actually

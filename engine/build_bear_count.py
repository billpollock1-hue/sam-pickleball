...
<div class="page">
  <div class="decoder">
    <div class="dc-card">
      ...
      <div class="dc-row"><span class="dc-icon">🏆</span><span><b>Shootout bear (men)</b> — finish on top of your pool by winning all 3 games. Leading with only 2 wins does not earn a bear (though it's tracked below).</span></div>
    </div>
  </div>
  ...
  <div class="wrap">
    ...
    <p class="foot" style="font-style:italic;">Bear totals exclude bears earned for International attire/language and "treat" bears.</p>
  </div>
</div>
